...
- File: `guides/google-indexing-api.md`; stable route: `/google-indexing-api`.
...
- 'It does not provide a general indexing service for every page on a website.' → 'Ordinary website pages are outside that supported use.'
