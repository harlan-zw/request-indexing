...
| Request Indexing implementation | 95 | https://github.com/harlan-zw/request-indexing ; `/blob/<revision>/*` | What the inspected revision implements. No live integration proof or guarantee. |
...
| Google employee original statements | 85 | https://bsky.app/profile/johnmu.com ; dated original posts and official office-hours transcripts | Original context required. Employee identity alone does not establish policy or implementation. |
