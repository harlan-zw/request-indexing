...
| PRODUCT-05 | Observed | Implementation inspection | Source code is GPLv3; stored indexing states are exposed through gscdump SDK. | No completed self-host guide, retention SLA, unlimited-row guarantee, or IndexNow implementation established. | LICENSE; README.md; apps/app/server/api/gscdump/[siteId]/indexing-urls.get.ts | 2026-09-15 | cf640ac5 |
