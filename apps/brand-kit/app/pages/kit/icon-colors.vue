...
const dataViz = [
  ...
  { label: 'LCP (CWV)', set: cwvMetricColors.lcp, key: 'cwvMetricColors.lcp' },
  { label: 'INP (CWV)', set: cwvMetricColors.inp, key: 'cwvMetricColors.inp' },
  { label: 'CLS (CWV)', set: cwvMetricColors.cls, key: 'cwvMetricColors.cls' },
