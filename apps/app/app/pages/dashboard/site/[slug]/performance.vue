...
<template>
  <div class="space-y-7">
        ...
        <div class="max-w-sm">
          <UPopover :popper="{ placement: 'bottom-end' }">
            <template #default="{ open }">
              <UButton size="xs" color="neutral" icon="i-ph-device-mobile-duotone" variant="ghost" :class="[open && 'bg-gray-50 dark:bg-gray-800']" trailing-icon="i-heroicons-chevron-down-20-solid">
    ...
    <div class="space-y-10">
      ...
      <UAlert v-if="connector?.rows && !connector.rows.length" color="info" variant="soft" title="No real-world data yet" description="Your origin does not currently have any real-world data. Check back again soon." />
    </div>
  </div>
</template>
