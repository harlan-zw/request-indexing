...
import { UDrawer, UiButton, UiIcon } from '#components'
  ...
  <div class="flex min-h-screen" data-allow-mismatch="children">
    ...
    >
      ...
      <div class="lg:hidden flex items-center gap-1 px-4 pt-3">
        <UiButton purpose="quiet" class="-ml-2 min-h-11 min-w-11 shrink-0" aria-label="Open navigation menu" @click="navOpen = true">
