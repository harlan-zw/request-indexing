...
const {
   ...
   * dividers span the full width. The rows own their inset instead — match the
   * header with `px-4 sm:px-(--density-card-padding)` so the two line up.
   */
  flush?: boolean
}>()
...
<template>
  <div class="relative flex flex-col">
    ...
    >
      ...
      <div v-else-if="title || slots.actions" class="relative border-b border-default shrink-0 flex flex-col items-stretch gap-3 sm:flex-row sm:items-start sm:justify-between" :class="headerClass">
        <div class="min-w-0">
