...
import { UiAtmosphere, UiButton, UiIcon } from '#components'
...
<template>
  <div class="relative">
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-[var(--ui-bg)]/70 via-[var(--ui-bg)]/95 to-[var(--ui-bg)]/75 backdrop-blur-[1px]">
      <!-- The pre-data preview read as data glimpsed through fog. -->
      <UiAtmosphere preset="preview" />
      <div class="relative w-full max-w-md rounded-lg border border-default bg-default/90 px-5 py-4 text-center shadow-lg ring-1 ring-black/5 dark:ring-white/5">
