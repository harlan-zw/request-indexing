...
import type { TableAsyncDataProps } from '~~/layers/core/app/components/Table/TableAsyncData.vue'
import type { GscDataRow } from '~~/layers/core/app/types/data'
import { formatPageSpeedInsightScore } from '~~/layers/design-system/composables/formatting'
    ...
    <template #page-data="{ row, expanded }">
      <div class="flex items-center">
        <div class="relative group w-[260px] max-w-full">
          ...
          <!--              </UTooltip> -->
          <!--              Crawled {{ formatTimeAgo(row.inspectionResult.indexStatusResult.lastCrawlTime) }} -->
          <!--            </div> -->
        </div>
      </div>
