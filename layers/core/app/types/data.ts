...
// `apps/app/server/api/sites/list.get.ts`), consumed by every dashboard fleet
// view: `CardSite`, `Header`, `HeaderSitesMenu`, the `dashboard` layout,
...
// row gets `undefined` and silently links to `/dashboard/site/undefined/...`.
