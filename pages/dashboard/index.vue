    ...
    <div class="py-10">
      <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-10">
          ...
          <div v-if="allSitesTotal" class="flex items-center justify-center gap-10">
            <div class="flex flex-col justify-center">
              ...
              <TrendPercentage v-if="allSitesTotal.prevPeriod.totalClicks > 0" :value="allSitesTotal.prevPeriod.totalClicks / allSitesTotal.period.totalClicks" />
            </div>
            <div class="flex flex-col justify-center">
              ...
              <TrendPercentage v-if="allSitesTotal.prevPeriod.totalImpressions > 0" :value="allSitesTotal.prevPeriod.totalImpressions / allSitesTotal.period.totalImpressions" />
            </div>
          </div>
        </div>
        <UButton variant="ghost" color="gray" icon="i-heroicons-arrow-path" :loading="isSyncLoading" @click="sync">
          Refresh
        </UButton>
      </div>
