...
useSchemaOrg([
  defineWebPage({
    '@type': 'CollectionPage',
    'name': 'Free Google Indexing Tools',
    'description': 'Free tools to check if your pages are indexed by Google, audit your site\'s index coverage, and diagnose indexing problems.',
  }),
])
