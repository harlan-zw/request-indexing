    ...
    >
      ...
      <template #footer>
        <NuxtLink to="/dashboard" class="flex items-center gap-2 group">
          ...
          <svg height="20" width="20" class="text-green-500 group-hover:text-green-300 transition" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 267 262" xml:space="preserve">
