 ...
 *       psiDesktopLcp: avg(sitePathDateAnalytics.psiDesktopLcp),
 *       psiMobileLcp: avg(sitePathDateAnalytics.psiMobileLcp),
 *       psiDesktopFcp: avg(sitePathDateAnalytics.psiDesktopFcp),
 *       psiMobileFcp: avg(sitePathDateAnalytics.psiMobileFcp),
 *       psiDesktopSi: avg(sitePathDateAnalytics.psiDesktopSi),
 *       psiMobileSi: avg(sitePathDateAnalytics.psiMobileSi),
 *       psiDesktopTbt: avg(sitePathDateAnalytics.psiDesktopTbt),
 *       psiMobileTbt: avg(sitePathDateAnalytics.psiMobileTbt),
 *       psiDesktopCls: avg(sitePathDateAnalytics.psiDesktopCls),
 *       psiMobileCls: avg(sitePathDateAnalytics.psiMobileCls),
 */
