      ...
      <div v-else-if="data" class="relative w-full h-full">
        <div class="flex px-5 pt-2 items-start justify-start gap-4">
          ...
          <div class="flex flex-col items-center justify-center gap-1">
            <div class="flex items-center justify-center gap-2">
              <TrendPercentage :value="data.analytics.prevPeriod.totalClicks / data.analytics.period.totalClicks" />
            ...
            <div class="flex items-center justify-center gap-2">
              <TrendPercentage :value="data.analytics.prevPeriod.totalImpressions / data.analytics.period.totalImpressions" />
              <div class="flex items-end gap-2">
